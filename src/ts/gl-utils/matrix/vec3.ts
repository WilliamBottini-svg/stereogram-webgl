...
class Vec3 {
    public static dotProduct(v1: Vec3, v2: Vec3): number {
        return v1._val[0] * v2._val[0] + v1._val[1] * v2._val[1] + v1._val[2] * v2._val[2];
    }
    ...
    public equals(other: Vec3): boolean {
        return (
            Math.abs(this._val[0] - other._val[0]) < EPSILON &&
    ...
    public get length(): number {
        const norm =
            this._val[0] * this._val[0] + this._val[1] * this._val[1] + this._val[2] * this._val[2];
